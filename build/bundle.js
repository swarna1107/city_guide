...
var app = (function () {
    ...
    // (21:8) <Link class="nav-link active" aria-current="page" to="/">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:8) <Link class=\\\"nav-link active\\\" aria-current=\\\"page\\\" to=\\\"/\\\">",
    		ctx
    	});
    ...
    // (22:8) <Link class="nav-link" to="/join">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:8) <Link class=\\\"nav-link\\\" to=\\\"/join\\\">",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "/");
    			add_location(a, file$2, 6, 4, 159);
    			attr_dev(span, "class", "navbar-toggler-icon");
    			add_location(span, file$2, 16, 6, 457);
    ...
    // (48:4) {#each results as r}
    function create_each_block(ctx) {
    	let div1;
    	let div0;
    	let h5;
    	let t0_value = /*r*/ ctx[4].name + "";
    	let t0;
    	let t1;
    	let h6;
    	let t2_value = /*r*/ ctx[4].city + "";
    	let t2;
    	let t3;
    	let a;
    	let t4_value = /*r*/ ctx[4].email + "";
    	let t4;
    	let a_href_value;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$1, 50, 10, 1207);
    			attr_dev(h6, "class", "card-subtitle mb-2 text-muted");
    			add_location(h6, file$1, 51, 10, 1254);
    			attr_dev(a, "class", "card-link");
    			attr_dev(a, "href", a_href_value = "mailto:" + /*r*/ ctx[4].email);
    			add_location(a, file$1, 52, 10, 1320);
    			attr_dev(div0, "class", "card-body");
    			add_location(div0, file$1, 49, 8, 1173);
    			attr_dev(div1, "class", "col-3 card");
    			add_location(div1, file$1, 48, 6, 1140);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*results*/ 1 && t0_value !== (t0_value = /*r*/ ctx[4].name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*results*/ 1 && t2_value !== (t2_value = /*r*/ ctx[4].city + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*results*/ 1 && t4_value !== (t4_value = /*r*/ ctx[4].email + "")) set_data_dev(t4, t4_value);

    			if (dirty & /*results*/ 1 && a_href_value !== (a_href_value = "mailto:" + /*r*/ ctx[4].email)) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 31, 6, 752);
    			attr_dev(form, "class", "d-flex");
    			add_location(form, file$1, 30, 4, 724);
    			attr_dev(button, "class", "col-6 p-3 m-5 btn btn-outline-success");
    			add_location(button, file$1, 40, 4, 945);
    			attr_dev(div0, "class", "row m-auto");
    			add_location(div0, file$1, 29, 2, 695);
    			attr_dev(div1, "class", "container d-flex vh-50 vw-100");
    			add_location(div1, file$1, 28, 0, 649);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$1, 46, 2, 1091);
    			attr_dev(div3, "class", "container");
    			add_location(div3, file$1, 45, 0, 1065);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "change", /*changeValue*/ ctx[2], false, false, false),
    					listen_dev(button, "click", /*searchCity*/ ctx[3], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ results, value, changeValue, searchCity });
    	...
    	return [results, value, changeValue, searchCity];
    }
    ...
    /* src/Join.svelte generated by Svelte v3.44.2 */

    const { console: console_1 } = globals;
    const file = "src/Join.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label0, "for", "exampleInputName");
    			attr_dev(label0, "class", "form-label");
    			add_location(label0, file, 37, 8, 825);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "exampleInputName");
    			attr_dev(input0, "aria-describedby", "emailHelp");
    			attr_dev(input0, "name", "name");
    			add_location(input0, file, 38, 8, 895);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file, 36, 6, 798);
    			attr_dev(label1, "for", "exampleInputEmail");
    			attr_dev(label1, "class", "form-label");
    			add_location(label1, file, 48, 8, 1141);
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "exampleInputEmail");
    			attr_dev(input1, "name", "email");
    			add_location(input1, file, 49, 8, 1221);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file, 47, 6, 1114);
    			attr_dev(label2, "for", "exampleCityName");
    			attr_dev(label2, "class", "form-label");
    			add_location(label2, file, 58, 8, 1432);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "id", "exampleCityName");
    			attr_dev(input2, "name", "city");
    			add_location(input2, file, 59, 8, 1501);
    			attr_dev(div2, "class", "mb-3");
    			add_location(div2, file, 57, 6, 1405);
    			add_location(form, file, 35, 4, 785);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 68, 4, 1690);
    			attr_dev(div3, "class", "container");
    			add_location(div3, file, 34, 2, 757);
    			attr_dev(div4, "class", "vh-50 vw-100");
    			add_location(div4, file, 33, 0, 728);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input2, /*data*/ ctx[0]["city"]);
    			append_dev(div3, t8);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*submitForm*/ ctx[1], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*data*/ 1 && input2.value !== /*data*/ ctx[0]["city"]) {
    				set_input_value(input2, /*data*/ ctx[0]["city"]);
    			}
    		},
    		i: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ useNavigate, data, navigate, submitForm });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: Router$1, Route: Route$1, Nav, Home, Join });
    	return [];
    }
